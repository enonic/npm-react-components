...
import {XpComponent} from '../../src/ComponentRegistry/XpComponent';
import {XpRegion} from '../../src/ComponentRegistry/XpRegion';
...
import {DefaultPage} from '../ComponentRegistry/DefaultPage';
import {ExamplePart} from '../ComponentRegistry/ExamplePart';
import {TwoColumnLayout} from '../ComponentRegistry/TwoColumnLayout';
...
componentProcessor.addLayout(TWO_COLUMNS_LAYOUT_DESCRIPTOR, {
	toProps: ({
		component,
		content,
		processedComponent,
...
componentProcessor.addPage(DEFAULT_PAGE_DESCRIPTOR, {
	toProps: ({
		component,
		content,
		processedComponent,
...
// 	});
	...
	it('is able to process a page component', () => {
		const decoratedPageComponent = componentProcessor.process({
		...
		// });
		const element = render(<XpComponent
			component={decoratedPageComponent as Component}
			componentRegistry={componentRegistry}
		/>).container;
		// console.debug(toDiffableHtml(element.outerHTML));
		expect(toDiffableHtml(element.outerHTML)).toEqual(toDiffableHtml(`
